package com.teste.kafkapoc.aspect;
...
public class LoggingAspect {
     ...
     * @param joinPoint
     */
    @Before("execution(* com.teste.kafkapoc.controller..*(..)) || execution(* com.teste.kafkapoc.dao..*(..))")
     ...
     * @param joinPoint
     */
    @After("execution(* com.teste.kafkapoc.controller..*(..)) || execution(* com.teste.kafkapoc.dao..*(..))")
     ...
     * @param joinPoint
     */
    @AfterThrowing(pointcut = "execution(* com.teste.kafkapoc.controller..*(..)) || execution(* com.teste.kafkapoc.dao..*(..))", throwing = "error")
